 ...
 */
public class MyFrameProcessor implements TextureFrameProcessor, AudioDataProcessor {
     ...
     * @param graphName the name of the file containing the binary representation of the graph.
     */
    public MyFrameProcessor(Context context, String graphName) {
        initializeGraphAndPacketCreator(context, graphName);
    }
     ...
     */
    public MyFrameProcessor(CalculatorGraphConfig graphConfig) {
            ...
            mediapipeGraph.addPacketCallback(
                    ...
                    new PacketCallback() {
                        ...
                        public void process(Packet packet) {
                            ...
                            Log.d("MyFrameProcessor","addVideoStreams:11111");
    ...
    public void onNewFrame(final Bitmap bitmap, long timestamp) {
        ...
        try {
            ...
            try {
                // addConsumablePacketToInputStream allows the graph to take exclusive ownership of the
                // packet, which may allow for more memory optimizations.
                mediapipeGraph.addPacketToInputStream(videoInputStream, packet, timestamp);
                //mediapipeGraph.addConsumablePacketToInputStream(videoInputStream, packet, timestamp);
                packet = null;
            } catch (MediaPipeException e) {
                // TODO: do not suppress exceptions here!
                if (asyncErrorListener == null) {
